package com.whn.web.controller;
...
import com.whn.maker.meta.MetaValidator;
import com.whn.web.annotation.AuthCheck;
import com.whn.web.common.BaseResponse;
import com.whn.web.common.DeleteRequest;
import com.whn.web.common.ErrorCode;
import com.whn.web.common.ResultUtils;
import com.whn.web.constant.UserConstant;
import com.whn.web.exception.BusinessException;
import com.whn.web.exception.ThrowUtils;
import com.whn.web.manager.CosManager;
import com.whn.maker.meta.Meta;
import com.whn.web.model.dto.generator.*;
import com.whn.web.model.entity.Generator;
import com.whn.web.model.entity.User;
import com.whn.web.model.vo.GeneratorVO;
import com.whn.web.service.GeneratorService;
import com.whn.web.service.UserService;
...
public class GeneratorController {
    ...
    public void useGenerator(
        ...
        // 需要登录
        User loginUser = userService.getLoginUser(request);
        log.info("userId = {} 使用生成器 id = {}", loginUser.getId(), id);
    ...
    public void makeGenerator(
        ...
        // 用户需登录
        User loginUser = userService.getLoginUser(request);
        log.info("userId = {} 在线制作代码生成器", loginUser.getId());
