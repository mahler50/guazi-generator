import {PageContainer, ProFormDatePicker, ProFormSelect, ProFormText, QueryFilter} from '@ant-design/pro-components';
import { useModel } from '@umijs/max';
import {Avatar, Card, Flex, Image, Input, List, message, Space, Tabs, Tag, theme, Typography} from 'antd';
            ...
            <Link to={`/generator/detail/${data.id}`}>
              <Card hoverable cover={<Image alt={data.name} src={data.picture} />}>
                ...
                <Flex justify="space-between" align="center">
                  <Typography.Text type="secondary" style={{ fontSize: 12 }}>{moment(data.createTime).fromNow()}</Typography.Text>
                  <div>
