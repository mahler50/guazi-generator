...
import com.whn.maker.meta.eunm.ModelTypeEnum;
...
public class MetaValidator {
    ...
    private static void validAndFillModelConfig(Meta meta) {
        ...
        for (Meta.ModelConfig.ModelInfo modelInfo :
                modelInfoList) {
            // 为 group，不校验
    ...
    private static void validAndFillFileConfig(Meta meta) {
        ...
        for (Meta.FileConfig.FileInfo fileInfo :
                fileInfoList) {
            ...
            // type: 默认 inputPath 有文件后缀(.java)为 file，否则为 dir
            ...
            // generateType: 如果文件不以".ftl"结尾，默认为 static，否则为 dynamic
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.whn");
        String version = StrUtil.emptyToDefault(meta.getVersion(), "1.0");
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "whn");
